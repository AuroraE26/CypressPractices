...
This test case go to an automation practice page, checks a specific checkbox, verifies if it's checked and its value. It cheks the box again and now verifies if it is unchecked, and finally checks two boxes at the same time.
